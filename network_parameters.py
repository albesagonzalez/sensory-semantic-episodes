...
network_parameters["mtl_sparsity"] = torch.tensor([0.2, 0.2])
network_parameters["mtl_sparsity_sleep"] = torch.tensor([0.1, 0.1])
...
network_parameters["mtl_semantic_sparsity"] = torch.tensor([0.2])
network_parameters["mtl_semantic_sparsity_sleep"] = torch.tensor([0.1])
